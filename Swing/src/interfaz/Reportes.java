...
//		setUndecorated(true);
		...
		Grafica grafica = new Grafica(Grafica.IMC); 
...
//		panel.setLayout(new GridLayout(2, 1, 0, 0));
		...
		JLabel etiqueta=new JLabel("Reportes Cronol—gicamente");
		etiqueta.setHorizontalAlignment(SwingConstants.CENTER);
		etiqueta.setSize(panel.getWidth(), etiqueta.getHeight());
		
		panel.add(etiqueta, BorderLayout.SOUTH);
		
		Grafica grafica1 = new Grafica(Grafica.PRESION); 
...
//		panel_1.setLayout(new GridLayout(2, 1, 0, 0));
		...
		panel_1.add(grafica1);
		
		JLabel etiqueta1=new JLabel("Reportes Cronol—gicamente");
		etiqueta1.setHorizontalAlignment(SwingConstants.CENTER);
		etiqueta1.setSize(panel_1.getWidth(), etiqueta1.getHeight());
		
		panel_1.add(etiqueta1, BorderLayout.SOUTH);
